 ...
 *
 * @package OneAccess\Tests\Integration
 */

declare( strict_types = 1 );

namespace OneAccess\Tests\Integration;

use OneAccess\Autoloader;
use OneAccess\Tests\TestCase;
use PHPUnit\Framework\Attributes\CoversClass;

#[CoversClass( \OneAccess\Autoloader::class )]
/**
...
final class AutoloaderTest extends TestCase {
	...
	public function test_missing_autoloader_notice_adds_admin_notices(): void {
		...
		$this->expectOutputRegex( '/OneAccess: The Composer autoloader was not found./' );
