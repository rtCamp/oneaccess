 ...
 *
 * @package OneAccess\Tests\Integration\Contracts\Traits
 */

declare( strict_types = 1 );

namespace OneAccess\Tests\Integration\Contracts\Traits;
 ...
 * Class SingletonTest
 */
#[CoversClass( \OneAccess\Contracts\Traits\Singleton::class )]
