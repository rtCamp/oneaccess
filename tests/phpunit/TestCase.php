 ...
 *
 * @package OneAccess\Tests
 */

declare( strict_types = 1 );

namespace OneAccess\Tests;
...
abstract class TestCase extends WP_UnitTestCase {
	...
	/**
	 * Don't inherit the parent class's checkRequirements() method, as it is deprecated and causes issues with PHPUnit 11.5.
	 *
	 * @deprecated
	 */
